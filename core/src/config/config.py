class Config(object):
    ...
    ALL_FEATURES = DIFF_FEATURES + DIST_FEATURES
    SCALER_MEAN = [0.21545425,  0.18870876,
                   0.22417245, 36.31055241, - 3.3004874]
    SCALER_STD = [0.22469747,  0.19965927,
                  0.22721309, 43.15776087, 18.39518668]
